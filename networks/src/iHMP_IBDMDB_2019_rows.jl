...
for p in percentages
    p_int = Int(p * 100)
    for i in 95:num_iterations
        filename = "sample_$(p_int)_run_$i.tsv"
        
        try
            # 1. Carga de datos
            path = "networks/iHMP_IBDMDB_2019/random_rows/$(p_int)/$(filename)"
            ...
            try
                ...
                FlashWeave.save_network("networks/iHMP_IBDMDB_2019/random_rows/networks/$(p_int)/$(filename_net_h)", healthy)
            catch e
            ...
            try
                ...
                FlashWeave.save_network("networks/iHMP_IBDMDB_2019/random_rows/networks/$(p_int)/$(filename_net_u)", unhealthy)
            catch e
