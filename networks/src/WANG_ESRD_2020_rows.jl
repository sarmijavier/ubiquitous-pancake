...
for p in percentages
    ...
    for i in 1:num_iterations
        ...
        try
            # 1. Carga de datos
            path = "networks/WANG_ESRD_2020/random_rows/$(p_int)/$(filename)"
            ...
            try
                ...
                FlashWeave.save_network("networks/WANG_ESRD_2020/random_rows/networks/$(p_int)/$(filename_net_h)", healthy)
            catch e
            ...
            try
                ...
                FlashWeave.save_network("networks/WANG_ESRD_2020/random_rows/networks/$(p_int)/$(filename_net_u)", unhealthy)
            catch e
